...
export const translations: Record<AppLanguage, TranslationDictionary> = {
  en: {
    ...
    feynman: {
      title: 'Defense',
      challengeTitle: 'Defense',
      tabooForbidden: 'Forbidden Words',
      yourExplanation: 'Your Explanation',
      placeholder: 'Explain how this works in simple words...',
      holdToSpeak: 'Hold to speak',
      releaseToSend: 'Release to send',
      ...
      passMessage: 'Great job. You defended this concept and proved mastery.',
      remediationMessage: 'Review added. A mini-lesson has been added to your roadmap.',
      tryAgain: 'Try Again',
      proceedNext: 'Next Lesson',
    },
  },
  am: {
    appName: 'አጠር',
    ...
    feynman: {
      title: 'የቃል መከላከያ',
      challengeTitle: 'የቃል መከላከያ',
      tabooForbidden: 'የተከለከሉ ቃላት',
      yourExplanation: 'የእርስዎ ማብራሪያ',
      placeholder: 'የፅንሰ-ሀሳቡን አሰራር በቀላል ቃላት ያስረዱ...',
      holdToSpeak: 'ተጭነህ ተናገር',
      releaseToSend: 'ስትጨርስ ልቀቅ',
      ...
      passMessage: 'በጣም ጥሩ። ፅንሰ-ሀሳቡን በሚገባ ተከላክለዋል፤ ማስተሪ ተረጋግጧል።',
      remediationMessage: 'አጭር የማካካሻ ትምህርት ወደ ፍኖተ-ካርታዎ ተጨምሯል።',
      tryAgain: 'እንደገና ሞክር',
      proceedNext: 'ቀጣይ ትምህርት',
    },
  },
};
