...
**Diplomacy is the specific mechanism the source isolates — not a background term, but the rule that governs what is possible within this domain.** Diplomacy is a key instrument of foreign policy that involves bargaining with less element of power. v They play the carrot and stick diplomacy to affect the outcomes of events or influence the behaviors of others o like Intervention, threat of use of force and some time, use of force v" The more unilateral a state is the more likely to initiate actions in international relations or to resist initiatives taken by others 2.2.5. A Macroeconomist reads this by asking three questions: what does Diplomacy do, what does it constrain, and what breaks when it is absent.

## The Global Economic Engine

Diplomacy works by connecting the source's key terms, rules, and examples into one usable idea. [[Instruments_Of_Foreign_Policy]] 1. Diplomacy e Diplomacy - process between actors (diplomats, usually representing a state) who exist within a system (international relations) and engage in private and public dialogue v diplomacy can promote exchanges that enhance trade, culture, wealth and knowledge e Diplomacy is not [[Foreign_Policy]] but part of foreign policy ¢ state's foreign policy has two key ingredients; its actions and its strategies for achieving its goals » The interaction one state has with another is considered the act of its foreign policy. This concept is directly related to [[National_Interest]].
...
[
  {
    "type": "mcq",
    "question": "Which statement best matches the source's treatment of Diplomacy?",
    "options": {
      "A": "Diplomacy is a key instrument of foreign policy that involves bargaining with less element of power.",
      "B": "Diplomacy is unrelated to the subject's behavior.",
      "C": "Diplomacy only describes comments and formatting.",
      "D": "Diplomacy can be ignored without changing program behavior."
    },
    "answer": "A",
  ...
  {
    "type": "writing",
    "question": "Explain Diplomacy in one precise paragraph and include one specific consequence from the source on page 18.",
    "answer": "A strong answer defines Diplomacy, states how it affects the system's behavior, and anchors the explanation in the source definition from page 18.",
    "required_keywords": [
      "source",
      "behavior"
    ],
