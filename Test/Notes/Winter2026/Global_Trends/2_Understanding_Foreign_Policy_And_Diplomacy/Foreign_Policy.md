...
[
  {
    "type": "mcq",
    "question": "Which statement best matches the source's treatment of Foreign Policy?",
    "options": {
      "A": "Foreign policy is the actions, decisions and goals that states pursue towards the outside world to achieve and promote t",
      "B": "Foreign Policy is unrelated to the subject's behavior.",
      "C": "Foreign Policy only describes comments and formatting.",
      "D": "Foreign Policy can be ignored without changing program behavior."
    },
    "answer": "A",
  ...
  {
    "type": "writing",
    "question": "Explain Foreign Policy in one precise paragraph and include one specific consequence from the source on page 1.",
    "answer": "A strong answer defines Foreign Policy, states how it affects the system's behavior, and anchors the explanation in the source definition from page 1.",
    "required_keywords": [
      "source",
      "behavior"
    ],
