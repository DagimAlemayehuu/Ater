...
**Diplomacy And Foreign Policy is the specific mechanism the source isolates — not a background term, but the rule that governs what is possible within this domain.** Diplomacy is a process between actors who engage in private and public dialogue to promote exchanges that enhance trade, culture, wealth, and knowledge, and is a key instrument of foreign policy. Global Trends Chapter 2 Chapter Two : Understanding Foreign Policy and Diplomacy Foreign policy e |tis the actions, decisions and goals that states pursue towards the outside world ¢ the deriving motives behind foreign policy is the pursuit of national interest v' States adopt foreign policy to achieve and promote their national interests e Foreign policy is shaped by both external/systemic factors and internal factors external/systemic factor o International regimes, international organizations o the prevalence of great powers at international level » internal factors o economic, technological and military capabilities of states 2.1. A Macroeconomist reads this by asking three questions: what does Diplomacy And Foreign Policy do, what does it constrain, and what breaks when it is absent.
...
[
  {
    "type": "mcq",
    "question": "Which statement best matches the source's treatment of Diplomacy And Foreign Policy?",
    "options": {
      "A": "Diplomacy is a process between actors who engage in private and public dialogue to promote exchanges that enhance trade,",
      "B": "Diplomacy And Foreign Policy is unrelated to the subject's behavior.",
      "C": "Diplomacy And Foreign Policy only describes comments and formatting.",
      "D": "Diplomacy And Foreign Policy can be ignored without changing program behavior."
    },
    "answer": "A",
  ...
  {
    "type": "writing",
    "question": "Explain Diplomacy And Foreign Policy in one precise paragraph and include one specific consequence from the source on page 1.",
    "answer": "A strong answer defines Diplomacy And Foreign Policy, states how it affects the system's behavior, and anchors the explanation in the source definition from page 1.",
    "required_keywords": [
      "source",
      "behavior"
    ],
