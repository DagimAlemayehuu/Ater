...
**Scope Of Foreign Policy is the specific mechanism the source isolates — not a background term, but the rule that governs what is possible within this domain.** The scope of a country's foreign policy refers to the extent of its activities and interests, which can be categorized into global, regional, or isolationist approaches. particularism, States could no longer be viable actors in addressing cross-cutting problems by themselves 2.2. A Macroeconomist reads this by asking three questions: what does Scope Of Foreign Policy do, what does it constrain, and what breaks when it is absent.
...
[
  {
    "type": "mcq",
    "question": "Which statement best matches the source's treatment of Scope Of Foreign Policy?",
    "options": {
      "A": "The scope of a country's foreign policy refers to the extent of its activities and interests, which can be categorized i",
      "B": "Scope Of Foreign Policy is unrelated to the subject's behavior.",
      "C": "Scope Of Foreign Policy only describes comments and formatting.",
      "D": "Scope Of Foreign Policy can be ignored without changing program behavior."
    },
    "answer": "A",
  ...
  {
    "type": "writing",
    "question": "Explain Scope Of Foreign Policy in one precise paragraph and include one specific consequence from the source on page 8.",
    "answer": "A strong answer defines Scope Of Foreign Policy, states how it affects the system's behavior, and anchors the explanation in the source definition from page 8.",
    "required_keywords": [
      "source",
      "behavior"
    ],
