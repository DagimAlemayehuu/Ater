...
**Self Preservation is the specific mechanism the source isolates — not a background term, but the rule that governs what is possible within this domain.** One possible pattern of foreign policy behavior is self-preservation, which involves maintaining the status quo for one's own benefit. A Macroeconomist reads this by asking three questions: what does Self Preservation do, what does it constrain, and what breaks when it is absent.

## The Global Economic Engine

Self Preservation works by connecting the source's key terms, rules, and examples into one usable idea. (page 13) 10 » the value placed on the objective » the time element placed on its achievement the kind of demands the objective imposes on other states in international system e the [[Foreign_Policy_Objectives]] of states categorizes in to three 1. This concept is directly related to [[Foreign_Policy]], [[National_Interest]].
...
[
  {
    "type": "mcq",
    "question": "Which statement best matches the source's treatment of Self Preservation?",
    "options": {
      "A": "One possible pattern of foreign policy behavior is self-preservation, which involves maintaining the status quo for one'",
      "B": "Self Preservation is unrelated to the subject's behavior.",
      "C": "Self Preservation only describes comments and formatting.",
      "D": "Self Preservation can be ignored without changing program behavior."
    },
    "answer": "A",
  ...
  {
    "type": "writing",
    "question": "Explain Self Preservation in one precise paragraph and include one specific consequence from the source on page 10.",
    "answer": "A strong answer defines Self Preservation, states how it affects the system's behavior, and anchors the explanation in the source definition from page 10.",
    "required_keywords": [
      "source",
      "behavior"
    ],
