...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Static Variables?",
    "options": {"A": "When objects of its class are declared, no copy of a static variable is made [SO", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Static Variables is defined by its relationship to this domain as described in the source material."
  }
]
```