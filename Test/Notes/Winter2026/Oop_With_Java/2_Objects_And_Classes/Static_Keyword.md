...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Static Keyword?",
    "options": {"A": "static indicates that the main() method is a class method not an instant method ", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Static Keyword is defined by its relationship to this domain as described in the source material."
  }
]
```