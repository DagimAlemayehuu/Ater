...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Main Method?",
    "options": {"A": "The main method is where a Java program always starts when you run a class file ", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Main Method is defined by its relationship to this domain as described in the source material."
  }
]
```