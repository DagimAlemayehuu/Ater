...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Call By Reference?",
    "options": {"A": "when you pass an object to a method, the situation changes dramatically, because", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Call By Reference is defined by its relationship to this domain as described in the source material."
  }
]
```