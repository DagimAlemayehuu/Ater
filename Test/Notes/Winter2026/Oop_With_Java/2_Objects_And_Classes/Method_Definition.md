...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Method Definition?",
    "options": {"A": "A method is a block of code that performs a specific task [SOURCE EXCERPT] Chapt", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Method Definition is defined by its relationship to this domain as described in the source material."
  }
]
```