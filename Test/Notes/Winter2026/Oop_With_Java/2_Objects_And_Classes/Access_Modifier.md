...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Access Modifier?",
    "options": {"A": "public (access modifier) makes the item visible from outside the class [SOURCE E", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Access Modifier is defined by its relationship to this domain as described in the source material."
  }
]
```