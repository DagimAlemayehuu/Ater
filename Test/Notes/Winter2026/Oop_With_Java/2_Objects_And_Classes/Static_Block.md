...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Static Block?",
    "options": {"A": "a static block is used to initialize static variables [SOURCE EXCERPT] // get vo", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Static Block is defined by its relationship to this domain as described in the source material."
  }
]
```