...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Call By Value?",
    "options": {"A": "when you pass a primitive type to a method, it is passed by value [SOURCE EXCERP", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Call By Value is defined by its relationship to this domain as described in the source material."
  }
]
```