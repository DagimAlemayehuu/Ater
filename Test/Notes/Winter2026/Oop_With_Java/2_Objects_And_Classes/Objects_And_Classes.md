...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Objects And Classes?",
    "options": {"A": "The provided document is a comprehensive guide to Java programming, covering fun", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Objects And Classes is defined by its relationship to this domain as described in the source material."
  }
]
```