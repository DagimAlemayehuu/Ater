...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Static Methods?",
    "options": {"A": "Normally, a class member must be accessed only in conjunction with an object of ", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Static Methods is defined by its relationship to this domain as described in the source material."
  }
]
```