...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Members Of A Class?",
    "options": {"A": "The data, or variables, defined within a class are called instance variables [SO", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Members Of A Class is defined by its relationship to this domain as described in the source material."
  }
]
```