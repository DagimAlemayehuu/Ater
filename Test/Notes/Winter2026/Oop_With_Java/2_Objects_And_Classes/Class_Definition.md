...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Class Definition?",
    "options": {"A": "A class defines a new data type [SOURCE EXCERPT] Chapter Two Objects and Classes", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Class Definition is defined by its relationship to this domain as described in the source material."
  }
]
```