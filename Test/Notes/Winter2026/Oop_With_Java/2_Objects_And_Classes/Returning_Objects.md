...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Returning Objects?",
    "options": {"A": "A method can return any type of data, including class types that you create [SOU", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Returning Objects is defined by its relationship to this domain as described in the source material."
  }
]
```