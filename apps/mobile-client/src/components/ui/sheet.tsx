    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'inset-y-0 end-0 h-full w-[85%] border-s data-[state=closed]:slide-out-to-end data-[state=open]:slide-in-from-end',
          side === 'left' &&
            'inset-y-0 start-0 h-full w-[85%] border-e data-[state=closed]:slide-out-to-start data-[state=open]:slide-in-from-start',
          side === 'top' &&
