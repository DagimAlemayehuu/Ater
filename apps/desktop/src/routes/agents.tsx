                ...
                <div className="flex flex-col gap-6 overflow-hidden">
                    ...
                    <div className="flex-1 rounded-xl border bg-card flex flex-col overflow-hidden shadow-sm">
                        <div className="p-4 border-b bg-muted/5">
                            <h3 className="text-xs font-black uppercase tracking-widest">Executive Logs</h3>
                        </div>
                        <div className="flex-1 bg-black p-4 font-mono text-[10px] text-white/80 overflow-y-auto custom-scrollbar">
                            {(status?.logs || []).map((log: string, i: number) => (
                                <p key={i} className="mb-1">{log}</p>
                            ))}
                            <p className="animate-pulse text-white/40">_</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="h-full flex flex-col space-y-6 animate-in fade-in duration-500 overflow-hidden">
            <div className="flex items-center justify-between border-b pb-4 shrink-0">
                ...
                <button 
                  ...
                  className="p-2 hover:bg-muted rounded-lg border text-xs font-black uppercase flex items-center gap-2">
                    <RefreshCw size={14} className={loading ? "animate-spin" : ""} /> Full Sync
                </button>
            </div>
