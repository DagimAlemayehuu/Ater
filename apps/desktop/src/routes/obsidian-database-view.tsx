...
export default function ObsidianDatabaseView({database, onBack, onNavigate, initialSelectedRowId}: ObsidianDatabaseViewProps) {
 ...
 className="flex items-center gap-3 text-foreground border border-border bg-background px-6 py-2.5 rounded-xl text-[10px] font-black tracking-[0.3em] uppercase hover:border-foreground/50 active:scale-95 transition-all shadow-xl shadow-foreground/5"
 >
 <Plus size={16} />
 Append
 </button>
