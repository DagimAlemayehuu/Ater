...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot='input'
      className={cn(
        'flex h-10 w-full min-w-0 rounded-[8px] border border-[#242426] bg-[#1a1a1c] px-3 py-1 text-sm shadow-xs transition-all outline-none selection:bg-foreground/10 selection:text-foreground placeholder:text-muted-foreground/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 text-foreground focus:border-foreground/20 focus:bg-[#232326]',
