          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-3xl mt-8">
            {[
              ...
              <div key={stat.label} className="p-4 border border-outline-variant bg-surface flex flex-col gap-1 text-left">
                <span className="text-[10px] opacity-50 uppercase">{stat.label}</span>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={hub.title} className="border border-outline-variant/30 p-3 bg-background/40 flex justify-between items-center">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    <span className="px-2 py-0.5 border border-outline-variant bg-background text-[9px]">{hub.conf}</span>
            ...
            <div className="border border-outline-variant/30 p-3 bg-background/20 flex flex-col gap-2">
              ...
              <div className="space-y-1 text-[10px]">
                <div className="flex justify-between items-center text-emerald-500 font-bold">
                  <span> Unit 1: Indexing Schemes</span>
                  <span>Done</span>
                </div>
                <div className="flex justify-between items-center text-emerald-500 font-bold">
                  <span> Unit 2: B-Trees Deep Study</span>
                  <span>Done</span>
                </div>
          ...
          <div className="w-full border border-outline-variant bg-surface p-6 flex flex-col gap-4 text-[11px] leading-relaxed relative overflow-hidden shadow-xl max-w-lg mx-auto order-last lg:order-first">
            ...
            <div className="border border-outline-variant/30 p-3 bg-background/20 flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-[9px] text-emerald-500 font-bold">
                <span> Sequential Leaves</span>
                <span> Height log(n)</span>
                <span>Tree Pointers</span>
                <span>Hash Buckets</span>
              </div>
            </div>
            
            <button className="h-10 border border-primary bg-primary text-background font-bold tracking-widest text-[9px] uppercase hover:bg-background hover:text-primary transition-colors">
              VIEW EXPLANATION
            </button>
          </div>
