        ...
        <div className="industrial-container w-full max-w-5xl mx-auto flex flex-col justify-center gap-6 md:gap-8 flex-1 py-8">
          <div className="flex flex-col gap-4 sm:p-6 md:p-8 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-12 items-center">
              ...
              <div className="w-full border border-outline-variant bg-surface p-6 flex flex-col gap-4 max-w-md mx-auto relative overflow-hidden shadow-xl font-mono text-[10px] text-left">
                <div className="flex justify-between items-center border-b border-outline-variant/30 pb-2">
                  <span className="text-primary font-black uppercase tracking-wider">&gt; SECURITY_DAEMON</span>
                ...
                <div className="space-y-2.5 opacity-80">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-on-surface">~/.ater/vault_config.json</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="opacity-40">FILE ENCRYPTION</span>
                    <span className="font-bold text-on-surface">AES-256-GCM LOCAL_STORE</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="opacity-40">INTERNET STATE</span>
                    <span className="font-bold text-red-500">OFFLINE_FIRST (100% PRIVATE)</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="border-t border-outline-variant/30 pt-2 flex items-center justify-between text-[8px]">
                  <span className="opacity-30 font-sans">ENCRYPTED_USING_USER_HARDWARE_KEY</span>
