...
export function Footer() {
  return (
    <footer className="relative md:sticky md:top-0 z-[100] min-h-[50vh] md:h-screen bg-background grid-background flex flex-col items-center justify-center border-t border-outline-variant py-20 md:py-0 stack-section">
