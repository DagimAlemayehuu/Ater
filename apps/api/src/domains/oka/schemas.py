...
class AtomicNoteSchema(NoteSchema):
    ...
    mode: Literal[
        ...
        "PHYSICS-KINEMATICS", "PHYSICS-ELECTRO", "PHYSICS-THERMO", "PHYSICS-QUANTUM",
        "CHEMISTRY", "CHEM-ORGANIC", "CHEM-PHYSICAL",
        "BIOLOGY", "BIO-ECOLOGY", "BIO-GENETICS",
        "EARTH-GEOLOGY", "SPACE-ASTRO",
        "ENG-MECH", "ENG-ELEC", "ENG-CIVIL", "ENG-CHEM", "ENG-AERO", "ENG-BIOMED",
        "MED-PHYSIO", "MED-PHARMA", "MED-ANATOMY", "MED-PATHOLOGY",
        "ECON-MACRO", "ECON-MICRO", "ECON-METRICS", "ECON-BEHAVIORAL", "ECON-FINANCE",
        "BIZ-STRATEGY", "BIZ-MARKETING", "BIZ-OPERATIONS",
        "LAW-CASE", "LAW-CONTRACT", "LAW-CRIMINAL", "LAW-CONSTITUTIONAL",
        "SOC-POLITICAL", "SOC-ANTHRO", "PSYCH-SOCIOLOGY",
        "HIST-CATALYST", "PHILOSOPHY", "HUM-RELIGION", "HUM-MUSIC", "HUM-ART_HIST",
        "LANG-LINGUISTICS", "LANG-LIT",
        "ARTS-DESIGN", "SKILLS-HARD", "SKILLS-FITNESS", "EDUCATION", "RESEARCH-METHODS"
    ] = Field(default="ACADEMIC-GENERAL")
