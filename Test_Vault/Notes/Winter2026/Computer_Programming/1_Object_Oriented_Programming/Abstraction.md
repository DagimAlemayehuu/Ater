...
[
  {
    ...
    "options": {"A": "Abstraction: Simplifying Complexity… [SOURCE EXCERPT] Chapter One Object-Oriente", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Abstraction is defined by its relationship to this domain as described in the source material."
  }
]
```