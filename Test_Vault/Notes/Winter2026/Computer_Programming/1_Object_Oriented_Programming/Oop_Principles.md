...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Oop Principles?",
    "options": {"A": "OOP Principles… [SOURCE EXCERPT] Chapter One Object-Oriented Programming and Jav", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Oop Principles is defined by its relationship to this domain as described in the source material."
  }
]
```