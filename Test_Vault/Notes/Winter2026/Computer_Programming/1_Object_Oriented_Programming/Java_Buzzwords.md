...
[
  {
    "type": "mcq",
    "question": "Which of the following best defines Java Buzzwords?",
    "options": {"A": "Java Buzzwords: Core Design Principles… [SOURCE EXCERPT] Chapter One Object-Orie", "B": "An unrelated concept", "C": "A deprecated approach", "D": "None of the above"},
    "answer": "A",
    "explanation": "Java Buzzwords is defined by its relationship to this domain as described in the source material."
  }
]
```