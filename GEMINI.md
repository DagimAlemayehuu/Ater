...
*   **The Bounded Contexts:** The `apps/` directory contains deployable user-facing applications: `desktop` (Tauri/React) and `api` (FastAPI sidecar).
...
*   **The Human-in-the-Loop Protocol:** The `resources/` folder holds user-provided specifications and reference files.
