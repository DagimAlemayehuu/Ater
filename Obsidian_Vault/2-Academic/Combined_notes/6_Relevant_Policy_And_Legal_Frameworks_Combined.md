...
```mermaid
timeline
    title Key Milestones in Disability Movement & Policy Evolution
...
```mermaid
timeline
    title Ethiopian Disability Legal History: Pre-1991
...
```mermaid
mindmap
  root((Ethiopian Building Proclamation No. 624/2009))
    - ("National Law: Building Construction & Renovation")
    - ("Key Mandate: Accessibility")
    ...
    - ("Aligns with/Operationalizes")
      -- ("Constitution of FDRE 1995 (Article 41(5))")
      -- ("UN Convention on the Rights of Persons with Disabilities (2006) - Article 9")
      -- ("Construction Policy of 2014 (Ethiopia)")
    - ("Impact: Removes Physical Barriers, Enhances Public Access")
```
```text
...
```mermaid
mindmap
  root((Proclamation No. 568/2008: Right to Employment of Persons with Disabilities))
    - ("Landmark Ethiopian Legislation: 2008")
    - ("Goal: Promote & Protect Employment Rights")
    - ("Key Provisions")
      -- ("Prohibits Discrimination based on Disability")
        --- ("Recruitment, Promotion, Working Conditions")
      -- ("Mandates Reasonable Accommodation")
        --- ("Adjustments to enable work")
      -- ("Establishes Employment Quotas (Certain Sectors)")
      -- ("Outlines Enforcement Mechanisms")
      -- ("Specifies Penalties for Non-Compliance")
    - ("Aligns with/Operationalizes")
      -- ("Constitution of FDRE 1995 (Article 41(5))")
      -- ("UN Convention on the Rights of Persons with Disabilities (2006) - Article 27")
      -- ("2008 National TVET Policy (Ethiopia)")
    - ("Impact: Enhances Economic Inclusion & Social Justice")
```
```text
