...
graph LR
    A[Emily's $10,000] --> B1[Travel Abroad]
    A --> B2[Pursue MBA]
    B1 --> C1{Broadened Cultural Understanding}
    B1 --> C2{Valuable Life Experiences}
    B2 --> D1{Enhanced Job Prospects}
    B2 --> D2{Higher Earnings Potential}
    C1 --> E1[Delay Entry into Workforce]
    C2 --> E1
    D1 --> E2[Significant Student Debt]
    D2 --> E2
    E1 --> F1[Opportunity Cost: MBA]
    E2 --> F2[Opportunity Cost: Travel]
