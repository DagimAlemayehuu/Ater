...
graph LR
            A[Economic Downturn] --> B[Decrease in Consumer Income]
            B --> C[Increase in Demand for Inferior Goods]
            C --> D[Higher Sales for Second-hand Clothes and Low-quality Goods]
            D --> E[Thrift Stores and Discount Retailers Benefit]
