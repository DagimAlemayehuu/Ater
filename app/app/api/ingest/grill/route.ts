...
TASK:
Evaluate the student's learning goal, baseline, and answers based on their responses so far:
1. Proactively check if any of their previous answers indicate a misconception or incorrect understanding from the pretest. If so, formulate EXACTLY ONE targeted follow-up question probing that specific misconception to help clarify their mental model.
2. If there are no misconceptions, or if you have already asked a follow-up question about a misconception, respond with "done": true immediately. Do not ask redundant questions.
3. If asking a follow-up question:
