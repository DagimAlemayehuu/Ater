...
graph TD
    jointly_developed_structure_and_shared_responsibility["Jointly Developed Structure and Shared Responsibility"]
    mutual_authority_and_accountability_for_success["Mutual Authority and Accountability for Success"]
    mutual_relationships_and_goals["Mutual Relationships and Goals"]
    sharing_of_resources_and_rewards["Sharing of Resources and Rewards"]
    mutual_relationships_and_goals --> jointly_developed_structure_and_shared_responsibility
    jointly_developed_structure_and_shared_responsibility --> mutual_authority_and_accountability_for_success
    mutual_authority_and_accountability_for_success --> sharing_of_resources_and_rewards
    sharing_of_resources_and_rewards --> mutual_relationships_and_goals
