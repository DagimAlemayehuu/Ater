...
## Design Principles
1. **Progressive Disclosure**: Hide complexity by default. Reveal power features and metadata only when they are contextually relevant to the user's current task.
2. **Surgical Precision**: Every pixel and word must earn its place. No decoration for the sake of decoration; every element serves a functional purpose.
3. **Monochromatic Focus**: Use contrast and tonal layering (greyscale) to communicate state and hierarchy, reducing cognitive load and visual fatigue.

## Accessibility & Inclusion
High contrast greyscale palette, clear typography (Inter), and keyboard-driven navigation patterns.
