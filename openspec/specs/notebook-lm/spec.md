...
## Purpose
This specification defines the integration requirements for Google NotebookLM inside Ater, covering Google authentication, notebook retrieval, source ingestion, studio asset generation, automated SQLite recall card synchronization, and Oracle chat agent routing.
