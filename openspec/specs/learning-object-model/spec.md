# Learning Object Model Spec

## Purpose
This specification defines the durable vault file model, metadata contracts, route resolution, lesson variant naming, artifact pack versioning, and Hub extension rules used by Ater's adaptive learning runtime.
...
- **THEN** it SHALL identify whether the match is self-study or coursework so later phases can extend the correct content route
